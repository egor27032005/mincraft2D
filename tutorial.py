...
def main(window):
    ...
    floor = [Block(i * block_size, 80, block_size, "bedrock.png") for i in
             range(-1000, (WIDTH * 2) // block_size)]
    bl=[Block(5,320,block_size, "bedrock.png"),Block(5,160,block_size, "bedrock.png")]
    objects = [*floor,*bl]
